...
summary.to_csv(OUT / "GSE193136_FASTP_RAW_QC_SUMMARY.csv", index=False)
...
group.to_csv(OUT / "GSE193136_FASTP_GROUP_SUMMARY.csv", index=False)
...
print(f"{status}: GSE193136 raw QC summarized for 12/12 samples")
