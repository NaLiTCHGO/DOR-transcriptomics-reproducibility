...
$Rows|Sort-Object srr,mate|Export-Csv (Join-Path $OutRoot 'GSE193136_FASTQ_INTEGRITY.csv') -NoTypeInformation -Encoding UTF8
...
Write-Output 'PASS: GSE193136 24/24 FASTQ passed expected-size and gzip integrity checks (MD5 intentionally omitted by local policy)'
